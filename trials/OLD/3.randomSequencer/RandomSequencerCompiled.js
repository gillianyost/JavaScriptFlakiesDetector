...
var CustomSequencer = /*#__PURE__*/function (_TestSequencer) {
  ...
  _createClass(CustomSequencer, [{
    ...
    value: function sort(tests) {
      var currentIndex = tests.length,
          randomIndex;

      while (currentIndex != 0) {
        randomIndex = Math.floor(Math.random() * currentIndex);
        currentIndex--;
        var _ref = [tests[randomIndex], tests[currentIndex]];
        tests[currentIndex] = _ref[0];
        tests[randomIndex] = _ref[1];
      }
...
}(_testSequencer["default"]);

var _default = CustomSequencer; // unbiased shuffle algorithm Fisher-Yates (Knuth) Shuffle
